...
import CoreFeatureThumb from 'assets/isosjsumobile.png';
import Briefcase from 'assets/core-feature/briefcase.svg';
import Secure from 'assets/core-feature/secure.svg';

const data = {
  subTitle: '',
  title: 'Access on your Android, iOS, Windows & Mac.',
  features: [
    {
      id: 1,
      imgSrc: Briefcase,
      altText: 'Bookmark Info',
      title: 'Bookmark Info',
      text:
        'Bookmark the events pages and details to stay updated and share with friends easily.',
    },
    {
      id: 2,
      imgSrc: Secure,
      ...
      text:
        'You are not alone, we are in this together and here to help you clarify and answer all your queries.',
    },
  ],
};
